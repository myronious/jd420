    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setError( 
        <>
          ...
          <br />
          Instead, use <a href="https://metamask.app.link/dapp/jd420.pages.dev/">this link for MetaMask Mobile </a> or <a href='https://go.cb-w.com/27I2siYYnqb'>COINBASE</a>, or you can directly interact with the smart-contract through <a href={this.generateContractUrl()} target="_blank">{this.state.networkConfig.blockExplorer.name}</a> and <strong>we do our best to provide you with the best user experience possible</strong>, even from the raw contract.<br />
          <br />
