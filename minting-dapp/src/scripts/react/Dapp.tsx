      ...
      this.setError( 
        <>
         ...
         <strong>ON A MOBILE DEVICE? <br />Use the links below to use the NFT Minting App in MetaMask or Coinbase's secure app.</strong> <br /><br />
          ...
          <hr /> <br /> 
          You can also mint DIRECTLY FROM THE <a href={this.generateContractUrl()} target="_blank">{this.state.networkConfig.blockExplorer.name}</a> SMART CONTRACT. Technical knowledge is required.<br /><br /></center>
          <hr /> 
        </>,
      );
    }
