        ...
        {!this.isWalletConnected() || !this.isSoldOut() ?
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              <hr /><span className="emoji">⚠️</span> Native Polygon MATIC tokens only. <br/><a href="https://chainlist.org/chain/137" target="_blank">Add POLYGON to MetaMask with this link.</a> <hr /><span className="emoji">⚠️</span> Not sure if you're using Native MATIC? <br/> Then please <a href="#" target="_blank">click this link to use our OpenSea storefront instead.</a><br />
              ...
              <hr /><span className="emoji">🌘</span><span className="emoji">🌗</span><span className="emoji">🌖</span><span className="emoji">🌕</span><span className="emoji">🌔</span><span className="emoji">🌓</span><span className="emoji">🌒</span>
